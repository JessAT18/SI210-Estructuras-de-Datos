========================================================================
   APLICACIÓN: Aplicacion colas estaticas Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Aplicacion colas estaticas.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Aplicacion colas estaticas.

Aplicacion colas estaticas.vcxproj
...
Aplicacion colas estaticas.vcxproj.filters
...
Aplicacion colas estaticas.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Aplicacion colas estaticas.pch y un archivo de tipos 
