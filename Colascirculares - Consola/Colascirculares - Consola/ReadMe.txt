========================================================================
    APLICACIÓN DE CONSOLA: Colascirculares - Consola 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Colascirculares - Consola.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Colascirculares - Consola.


Colascirculares - Consola.vcxproj
...
Colascirculares - Consola.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Colascirculares - Consola.pch y un archivo de tipos 
